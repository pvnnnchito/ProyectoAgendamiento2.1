...
import { eliminarCliente, getAllCliente } from "./ClienteService";
import { AgendaClientesComponent } from "./AgendaComponent";
import clienteImagen from "../assets/Clientes.svg";


const initialAgendaCliente=[
    {
        key:"",
        nombre:"",
        correo:"",
...
const ClienteAgendaComponent=()=>{

    const [agendaClientes, setAgendaClientes]= useState(initialAgendaCliente);

    const obtenerCliente = async()=>{
        setAgendaClientes(await getAllCliente());
    }
    ...
    return(
        ...
        <header>
            ...
            <div className="text-center">
                    <img src={clienteImagen} alt="empleado" />
                </div>
        {
            agendaClientes.map(cliente => <AgendaClientesComponent 
                key={cliente.id}
                cliente={cliente}
...
export default ClienteAgendaComponent;